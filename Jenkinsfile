pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "venkateshakula/studybuddyai"
    ...
    stages {
        stage('Checkout Github') {
            steps {
                ...
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'studybuddy', url: 'https://github.com/Venkatesh-Akula/STUDY-BUDDY-AI1.git']])
